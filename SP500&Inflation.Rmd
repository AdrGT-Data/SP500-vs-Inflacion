...
ES: Con este contraste queremos ver si las **distribuciones** de `ret_12m` son iguales en los tres regímenes. Al darnos como resultado un p-valor tan bajo debemos **rechazar** la hipótesis nula de que todas pertenecen a la misma distribución, **al menos** una difiere. Esto lo podemos traducir a que estadísticamente existen diferencias sustanciales, y por tanto económicamente relevantes, entre los regímenes.
...
- Usar como cortes los cuantiles en vez del 2% y 4%. Esto se haría por demostrar que los resultados no dependen de una elección arbitraria de umbrales.
...
# (Opcional) por régimen de inflación
neg_by_reg <- mezcla |>
